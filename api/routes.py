...
rest_api.add_resource(Register, '/api/users/register')
rest_api.add_resource(Login, '/api/users/login')
rest_api.add_resource(EditUser, '/api/users/edit')
rest_api.add_resource(LogoutUser, '/api/users/logout')
rest_api.add_resource(GitHubLogin, '/api/sessions/oauth/github/')
